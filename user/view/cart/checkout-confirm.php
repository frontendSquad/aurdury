...
<section class="cartDetail py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="cartTotalBox bg-white shadow">
                    <div class="titleBox">
                        ...
                        <div class="text-center mb-3">
                            <a data-toggle="modal" data-target="#cart"
                                class="bg-gradient font-weight-bold d-block rounded-pill border-0 py-2 text-white">Place Order</a>
                        </div>
                        <div class="form-check mb-0">
                            <input class="form-check-input" type="radio" name="shipping" id="ship" value="option1">
                            <label class="form-check-label font-13" for="ship">
            ...
            <div class="col-md-6">
                <div class="coupon vendorSearch d-flex gap-15 align-items-center">
                    <button class="rounded-pill bg-dark border-0 px-5 py-2 text-white h-100">Back To Shopping</button>
                </div>
            </div>
        </div>
    </div>

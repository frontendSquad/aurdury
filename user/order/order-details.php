    ...
    <div class="container">
        ...
        <div class="shadow p-4 rounded-15 mb-5">
            <div class="row">
                ...
                <div class="col-md-9">
                    <p class="status goldenColor text-uppercase" id="status">PENDING</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row mt-3 deliveredBtn" style="display: none;">
                <div class="col-md-12">
                    <p class="mb-0"><a href="./order-detail-report.php" class="rounded-pill bg-gradient border-0 px-5 py-2 text-white">Report Order</a></p>
                </div>
            </div>

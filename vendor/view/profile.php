            ...
            <div class="col-12 col-md-8 col-lg-10">
                <div class="detail-block media d-lg-flex d-block">
                    ...
                    <div class="media-body flex-grow-1">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 mt-3 d-flex text-center">
                                <div class="d-flex flex-column">
                                    <a href="edit-profile.php" class="btn btn-secondary">Edit Profile Information</a>
                                    <a href="change-password.php" class="inline-link mt-2">Change Password</a>
                                </div>
                            </div>
                        </div>
                    </div>

    ...
    <div class="row">
        <div class="col-12">
            <div class="content-body">
                ...
                <div class="card-dashboard mt-2 mt-md-3 mb-0 mb-md-3">
                    <div class="row">
                                ...
                                <div class="card-body blue py-4">
                                    <div class="media align-items-center d-flex w-100">
                                        ...
                                        <div class="align-self-center flex-shrink-1">
                                            <img src="../assets/images/total-user.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-2 d-flex align-items-stretch">
                            <div class="card position-relative">
                                <div class="card-body yellow py-4">
                                    <div class="media align-items-center d-flex w-100">
                                        <div class="media-body text-left flex-grow-1">
                                        ...
                                        <div class="align-self-center flex-shrink-1">
                                            <img src="../assets/images/total-vendor.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-5 col-xl-3 mb-2 d-flex align-items-stretch">
                            <div class="card position-relative text-center">
                                <div class="card-header rounded-top-left-right yellow-header">
                                    <h6 class="text-white fs-16 fw-regular mb-0 py-2">Total Registered Vendors</h6>
                                </div>
                                <div class="card-body py-4">
                ...
                <div class="mt-5 mb-3">
                    <h3 class="fs-30 text-black fw-bold mb-0 align-self-center">Earning Stats</h3>
                </div>
                ...
                <div class="mt-5">
                    <h3 class="fs-30 text-black fw-bold mb-0 align-self-center">Recent Orders</h3>
                </div>

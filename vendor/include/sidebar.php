    ...
    <div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item <?php if ($pg == "user-management") { echo "active"; } ?>">
                    <a href="user-management.php"><img src="../assets/images/user-management.png" alt=""
                            class="img-fluid"><span class="menu-title">User Management</span></a>
                    <ul class="menu-content">
                        <li class="<?php if($pg =="user-management") {echo "active";} else{ echo "";}?>"><a
                                class="menu-item" href="user-listing.php">Listing</a></li>
                    </ul>
                </li>
                <li class="nav-item <?php if ($pg == "vendor-management") { echo "active"; } ?>">
                    <a href="vendor.php"><img src="../assets/images/vendor.png" alt="" class="img-fluid"><span
                            class="menu-title">Vendor</span></a>
                    <ul class="menu-content">
                        <li class="<?php if($pg =="vendor-management") {echo "active";} else{ echo "";}?>"><a class="menu-item"
                                href="vendor-listing.php">Listing</a></li>
                        <li class="<?php if($pg =="vendor-management") {echo "active";} else{ echo "";}?>"><a class="menu-item"
                                href="vendor-approval.php">Approval</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item <?php if ($pg == "settings") { echo "active"; } ?>">
                    <a href="settings.php" class="mm-next"><img src="../assets/images/settings.png" alt=""
                            class="img-fluid"><span class="menu-title" data-i18n="">Settings</span></a>
                </li>
                <li class="nav-item <?php if ($pg == "feedback") { echo "active"; } ?>">
                    <a href="feedback-listing.php" class="mm-next"><img src="../assets/images/feedback.png" alt=""
                            class="img-fluid"><span class="menu-title" data-i18n="">Feedback</span></a>
                </li>
                <li class="nav-item <?php if ($pg == "newsletter-listing") { echo "active"; } ?>">
                    <a href="newsletter-listing.php" class="mm-next"><img src="../assets/images/newsletter.png" alt=""
                            class="img-fluid"><span class="menu-title" data-i18n="">Newsletter</span></a>
                </li>
                <li class="nav-item <?php if ($pg == "commission") { echo "active"; } ?>">
                    <a href="commission.php" class="mm-next"><img src="../assets/images/commission.png" alt=""
                            class="img-fluid"><span class="menu-title" data-i18n="">Commission</span></a>
                </li>
                <li class="nav-item <?php if ($pg == "report-order-log") { echo "active"; } ?>">
                    <a href="report-order-log.php" class="mm-next"><img src="../assets/images/report-management.png"
                            alt="" class="img-fluid"><span class="menu-title" data-i18n="">Report Management</span></a>
                </li>
            </ul>
        </div>
    </div>
